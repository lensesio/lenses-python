...
=================
   ...
   * [Documentation](#documentation)
         * [Authentication](#authentication)
            ...
            * [Managing Connect Distributed](#managing-connect-distributed)
               ...
               * [Get Connector's Configuration](#get-connectors-configuration)
               * [Get Connector's Status](#get-connectors-status)
               * [Get Connector's Tasks](#get-connectors-tasks)
               * [Get Connector's Task Status](#get-connectors-task-status)
               * [Restart a Task](#restart-a-task)
               * [Get Connector's plugins](#get-connectors-plugins)
               * [Pause a Connector](#pause-a-connector)
               * [Resume a Connector](#resume-a-connector)
               * [Restart a Connector](#restart-a-connector)
               * [Update Connector's configuration](#update-connectors-configuration)
            ...
            * [SQL Processors](#sql-processors)
               ...
               * [Update Processor's Runners](#update-processors-runners)
            ...
            * [Lenses Admin](#lenses-admin)
               ...
               * [Get Lenses Configuration](#get-lenses-configuration)
               * [Get Lenses Audits](#get-lenses-audits)
               * [Get Lenses Alerts](#get-lenses-alerts)
               * [Get Lenses Logs (Java Logs)](#get-lenses-logs-java-logs)
            * [Registry](#registry)
   ...
   * [To activate just run workon myvirtenv](#to-activate-just-run-workon-myvirtenv)
      ...
      * [Integration Tests](#integration-tests)
            ...
            * [Start Lenses Box](#start-lenses-box)
            * [Run tests](#run-tests)
