...
class AdminPanel:
    ...
    def __init__(self):
        ...
        self.admin_x_headers = {'Content-Type': 'application/json', 'Accept': 'application/json',
                            'x-kafka-lenses-token': self.token}
        self.admin_text_plain_headers = {'Content-Type': 'application/json', 'Accept': 'text/plain',
                            'x-kafka-lenses-token': self.token}

    def GetGroups(self):
        __RQE = self.admin_groups_endpoint
        self.getGroups = exec_request(__METHOD="get",
            __EXPECTED="json",
            __URL=__RQE,
    ...
    def UpdateGroup(self, group, payload):
        ...
        self.updateGroup = exec_request(__METHOD="put",
            __EXPECTED="text",
            __URL=__RQE,
            __HEADERS=self.admin_text_plain_headers,
            __DATA=payload)
    ...
    def DeleteGroup(self, group):
        __RQE = self.url + "/api/v1/group/" + group
        self.deleteGroup = exec_request(__METHOD="delete",
            __EXPECTED="text",
            __URL=__RQE,
            __HEADERS=self.admin_text_plain_headers)
    ...
    def CreateUser(self, acType=None, username=None, password=None, email=None, groups=None):
        ...
        self.createUser = exec_request(__METHOD="post",
            __EXPECTED="text",
            __URL=__RQE,
            __HEADERS=self.admin_text_plain_headers,
            __DATA=payload)
    ...
    def UpdateUser(self, acType=None, username=None, password=None, email=None, groups=None):
        ...
        self.updateUser = exec_request(__METHOD="put",
            __EXPECTED="text",
            __URL=__RQE,
            __HEADERS=self.admin_text_plain_headers,
            __DATA=payload)
    ...
    def UpdateUserPassword(self, username, password):
        ...
        self.updateUserPassword = exec_request(__METHOD="put",
            __EXPECTED="text",
            __URL=__RQE,
            __HEADERS=self.admin_text_plain_headers,
            __DATA=payload)
    ...
    def GetServiceAccounts(self):
        ...
        self.getServiceAccounts = exec_request(__METHOD="get",
            __EXPECTED="json",
            __URL=__RQE,
            __HEADERS=self.admin_text_plain_headers)
    ...
    def CreateSA(self, name=None, owner=None, groups=None, token=None):
        ...
        self.createSA = exec_request(__METHOD="post",
            __EXPECTED="json",
            __URL=__RQE,
            __HEADERS=self.admin_text_plain_headers,
            __DATA=payload)
    ...
    def UpdateSA(self, name=None, owner=None, groups=None):
        ...
        self.updateSA = exec_request(__METHOD="put",
            __EXPECTED="text",
            __URL=__RQE,
            __HEADERS=self.admin_text_plain_headers,
            __DATA=payload)
    ...
    def UpdateSAToken(self, name=None, token=None):
        ...
        if token:
            ...
            self.updateSAToken = exec_request(__METHOD="put",
                __EXPECTED="json",
                __URL=__RQE,
                __HEADERS=self.admin_text_plain_headers,
                __DATA=payload)
    ...
    def Audits(self, pageSize=999999999):
        ...
        self.audits = exec_request(__METHOD="get",
            __EXPECTED="json",
            __URL=__RQE,
    ...
    def GetLogs(self, type='INFO'):
        ...
        self.getLogs = exec_request(__METHOD="get",
            __EXPECTED="json",
            __URL=__RQE,
            __HEADERS=self.admin_x_headers)
